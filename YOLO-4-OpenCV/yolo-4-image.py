...
"""
CoYOLO-3-OpenCV.zipurse:  Training YOLO v4 for Objects Detection with Custom Data

Section-2
Objects Detection on Image with YOLO v4 and OpenCV
...
#
# Algorithm:
# Reading RGB image --> Getting Blob --> Loading YOLO v4 Network -->
...
image_BGR = cv2.imread('C:/Users/gaura/Desktop/solutions/Yolo/YOLO-3-OpenCV/images/women-looking-financial-documents.jpg')
...
with open('C:/Users/gaura/Desktop/solutions/Yolo/YOLO-4-OpenCV/yolo-coco-data/coco.names') as f:
...
network = cv2.dnn.readNetFromDarknet('C:/Users/gaura/Desktop/solutions/Yolo/YOLO-4-OpenCV/yolo-coco-data/yolov4.cfg',
                                     'C:/Users/gaura/Desktop/solutions/Yolo/YOLO-4-OpenCV/yolo-coco-data/yolov4.weights')
